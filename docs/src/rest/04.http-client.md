...
`ConfigureHttpClient` exposes the standard `HttpClient` configuration API. See the <a href="https://learn.microsoft.com/dotnet/api/system.net.http.httpclient" target="_blank"><code>HttpClient</code> API reference</a> for the available configuration options.
