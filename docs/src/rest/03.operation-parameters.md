...
Use the `queryComplete` argument to control this behavior. When `queryComplete` is `true`, Flux.REST replaces path placeholders but does not append any operation parameters or pagination values.
