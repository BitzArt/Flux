...
You can use named parameters to provide values for path placeholders and query parameters:
...
By default, Flux.REST automatically appends the following query parameters:
