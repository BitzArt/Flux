...
`ConfigureJsonSerializer` exposes the standard `JsonSerializerOptions` API. See the <a href="https://learn.microsoft.com/dotnet/api/system.text.json.jsonserializeroptions" target="_blank">official <code>JsonSerializerOptions</code> API reference</a> for the available configuration options.
