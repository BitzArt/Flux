...
See useage example for different implementations:
* For REST services, use [Flux.REST](rest/01.introduction.md).
* For JSON services, use [Flux.Json](json/01.introduction.md).
