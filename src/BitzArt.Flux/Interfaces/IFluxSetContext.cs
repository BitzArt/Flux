    ...
    where TModel : class
{
    ...
    public Task<IEnumerable<TModel>> GetAllAsync(CancellationToken cancellationToken, params object[]? parameters);

    public Task<PageResult<TModel>> GetPageAsync(int offset, int limit, params object[]? parameters);
    public Task<PageResult<TModel>> GetPageAsync(int offset, int limit, CancellationToken cancellationToken, params object[]? parameters);

    public Task<PageResult<TModel>> GetPageAsync(PageRequest pageRequest, params object[]? parameters);
    public Task<PageResult<TModel>> GetPageAsync(PageRequest pageRequest, CancellationToken cancellationToken, params object[]? parameters);

    public Task<TModel> GetAsync(object? id = null, params object[]? parameters);
    public Task<TModel> GetAsync(CancellationToken cancellationToken, object? id = null, params object[]? parameters);

    public Task<TModel> AddAsync(TModel model, params object[]? parameters);
    public Task<TModel> AddAsync(TModel model, CancellationToken cancellationToken, params object[]? parameters);

    public Task<TResponse> AddAsync<TResponse>(TModel model, params object[]? parameters);
    public Task<TResponse> AddAsync<TResponse>(TModel model, CancellationToken cancellationToken, params object[]? parameters);

    public Task<TModel> UpdateAsync(object? id, TModel model, bool partial = false, params object[]? parameters);
    public Task<TModel> UpdateAsync(object? id, TModel model, CancellationToken cancellationToken, bool partial = false, params object[]? parameters);

    public Task<TModel> UpdateAsync(TModel model, bool partial = false, params object[]? parameters);
    public Task<TModel> UpdateAsync(TModel model, CancellationToken cancellationToken, bool partial = false, params object[]? parameters);

    public Task<TResponse> UpdateAsync<TResponse>(object? id, TModel model, bool partial = false, params object[]? parameters);
    public Task<TResponse> UpdateAsync<TResponse>(object? id, TModel model, CancellationToken cancellationToken, bool partial = false, params object[]? parameters);

    public Task<TResponse> UpdateAsync<TResponse>(TModel model, bool partial = false, params object[]? parameters);
    public Task<TResponse> UpdateAsync<TResponse>(TModel model, CancellationToken cancellationToken, bool partial = false, params object[]? parameters);
}
