...
public static class UsingJsonExtension
{
    ...
    public static IFluxJsonServiceBuilder UsingRest(this IFluxServiceProtocolConfigurator protocolConfigurator, string? baseFilePath = null, Action<JsonSerializerOptions>? configureJsonSerializer = null)
    {
